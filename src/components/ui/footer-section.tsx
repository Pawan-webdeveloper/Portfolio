        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic">
              ...
              <p>X: PAWAN54167 </p>
              <p>Email: pawan572893@gmail.com</p>
            </address>
          </div>
          <div className="relative">
            <h3 className="mb-4 text-lg font-semibold">Connect on Social media</h3>
            <div className="mb-6 flex space-x-4">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="outline" size="icon" className="rounded-full">
                      <a href="https://github.com/Pawan-webdeveloper">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="outline" size="icon" className="rounded-full">
                      <a href="https://www.linkedin.com/in/pawan-sah-661a86327">
