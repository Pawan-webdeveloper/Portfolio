...
export function Hero({
  ...
  return (
    ...
    >
      ...
      {/* CTA Buttons */}
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-[-20px]">
        {ctaLabel && (
          <Button
            asChild
            size="lg"
        ...
        <Button
          ...
          size="lg"
          variant="outline"
          className="border-2 border-gray-300/20 dark:border-white/20 
          bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent 
          hover:from-zinc-300/10 hover:via-gray-400/10 
          font-geist tracking-tighter text-lg px-8 py-3 rounded-full 
          transition-all duration-300 shadow-lg hover:shadow-xl 
          transform hover:scale-105 text-gray-700 dark:text-gray-300 
